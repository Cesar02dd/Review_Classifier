...
class DataCleaning:
    ...
    def remove_duplicates(self):
        try:
            ...
            if self.data_loader.labels is None:
            ...
            self.data_loader.data.drop_duplicates(inplace=True)
            self.data_loader.labels = self.data_loader.labels[self.data_loader.data.index]
    ...
    def handle_missing_values(self, strategy='drop'):
        try:
            ...
            if self.data_loader.data_train.isnull().sum().sum() == 0 and self.data_loader.data_test.isnull().sum().sum() == 0 and self.data_loader.data.isnull().sum().sum() == 0:
            ...
            if strategy == 'mean':
                ...
                self.data_loader.data.fillna(self.data_loader.data.mean(), inplace=True)
                ...
                self.data_loader.data.fillna(self.data_loader.data.median(), inplace=True)
                ...
                self.data_loader.data.fillna(self.data_loader.data.mode().iloc[0], inplace=True)
                ...
                self.data_loader.data.fillna(strategy, inplace=True)
            elif strategy == 'drop':
                self.data_loader.data = self.data_loader.data.dropna(axis=0)
                self.data_loader.labels = self.data_loader.labels[self.data_loader.data.index]
    ...
    def _detect_outliers(self):
        try:
            ...
            print("\nDetecting outliers:")
            for feature in self.data_loader.data.select_dtypes(include=[np.number]).columns:
                ...
                outliers = self.data_loader.data[
                    (self.data_loader.data[feature] < lower_bound) | (self.data_loader.data[feature] > upper_bound)]
    ...
    def remove_outliers(self):
        try:
            ...
            self.data_loader.data = self.data_loader.data.drop(outliers.index)
            self.data_loader.labels = self.data_loader.labels[self.data_loader.data.index]
